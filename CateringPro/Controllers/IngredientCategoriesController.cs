...
namespace CateringPro.Controllers
{
    ...
    public class IngredientCategoriesController : GeneralController<IngredientCategories>
    {
        public IngredientCategoriesController(AppDbContext context, IGenericModelRepository<IngredientCategories> repo, ILogger<IngredientCategories> logger, IConfiguration Configuration)
