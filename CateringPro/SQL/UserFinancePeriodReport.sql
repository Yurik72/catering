...
-- =============================================
CREATE OR ALTER PROCEDURE [dbo].[UserFinancePeriodReport]
...
Select ud.Date,g.name as GroupName, Isnull(u.ChildNameSurname,'') as ChildNameSurname, ud.Total as Total, Isnull(ud.Discount,0) as Discount, Isnull(ud.TotalWtithoutDiscount,0) as TotalWtithoutDiscount
...
from UserDay ud
 ...
 --inner join UserFinance uf on u.Id =uf.UserId 
...
order by ud.Date,g.name,u.ChildNameSurname
