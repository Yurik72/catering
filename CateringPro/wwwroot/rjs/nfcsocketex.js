...
nfc_socket.prototype.seturl = function (url) {
    if (this.issocketconnected)
        throw "Unable to change url, when connected"
    this.options.url=url;
}

nfc_socket.prototype.url = function () {
...
nfc_socket.prototype.connect=function (){
    ...
    var self = this;
    self.events.triggerHandler('state', 'connecting');
    ...
    var stateupdate = function (cmd, event) {
        ...
        self.events.triggerHandler('state', event);
    }
...
nfc_socket.prototype.isconnecting = function () {
    return this.socket.readyState == WebSocket.CONNECTING;
}
nfc_socket.prototype.issocketconnected = function () {
    return this.socket && this.socket.readyState == WebSocket.OPEN;
}
nfc_socket.prototype.isconnected = function () {
    return this.issocketconnected() && this.NFCReady();
}
